...
def main():
    ...
    parser.add_argument("--temporal-window", type=int, default=5, help="Odd-numbered median window for stable counts (default: 5)")
    ...
    print("=" * 64)
    print("SATARK — Continuous Video Crowd Counting Engine")
    print("=" * 64)
